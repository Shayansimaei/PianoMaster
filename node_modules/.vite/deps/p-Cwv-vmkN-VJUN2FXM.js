import {
  ...
  f,
  i
} from "./chunk-4S3CZUCP.js";
import {
  i as i2,
  t
} from "./chunk-JS4RZAUF.js";
import {
  d,
  e,
  l,
  u
} from "./chunk-MB6TAFSC.js";
import "./chunk-FN3RIYR5.js";
import {
  d as d2,
  o
} from "./chunk-3HXXZMMI.js";
...
var x = async (o2, n, r, a, e2, d3, c2 = false, l2 = 0, u3 = true) => {
  if (!r && !a) return;
  ...
  if (f2(o2, n, true, w2.inputSafeY, c2), v(n), d(() => o2.click()), d3 && r && (h = w2.scrollPadding, y(r, h)), "undefined" != typeof window) {
    let a2;
    const e3 = async () => {
      void 0 !== a2 && clearTimeout(a2), window.removeEventListener("ionKeyboardDidShow", s), window.removeEventListener("ionKeyboardDidShow", e3), r && await c(r, 0, w2.scrollAmount, w2.scrollDuration), f2(o2, n, false, w2.inputSafeY), document.activeElement === n && v(n), d3 && S(n, r, () => h = 0);
    }, s = () => {
    ...
    if (i4) {
      ...
      if ("date" !== i4.type && "datetime-local" !== i4.type && (s2 || l2) && p2 && !M2.has(n)) {
        const t4 = ((n2, t5, i5, r, a, e2, s3, d3 = false) => {
          ...
          let u4 = false;
          const f3 = void 0 !== d2 ? d2.innerHeight : 0, w3 = (o2) => {
            false !== u4 ? x(n2, t5, i5, r, o2.detail.keyboardHeight, l3, d3, f3, false) : u4 = true;
          }, p3 = () => {
            u4 = false, null == d2 || d2.removeEventListener("ionKeyboardDidShow", w3), n2.removeEventListener("focusout", p3);
          }, m2 = async () => {
            t5.hasAttribute(D) ? t5.removeAttribute(D) : (x(n2, t5, i5, r, a, l3, d3, f3), null == d2 || d2.addEventListener("ionKeyboardDidShow", w3), n2.addEventListener("focusout", p3));
          };
          return n2.addEventListener("focusin", m2), () => {
            n2.removeEventListener("focusin", m2), null == d2 || d2.removeEventListener("ionKeyboardDidShow", w3), n2.removeEventListener("focusout", p3);
          };
...
@ionic/core/components/p-Cwv-vmkN.js:
   ...
   *)
*/
//# sourceMappingURL=p-Cwv-vmkN-VJUN2FXM.js.map
