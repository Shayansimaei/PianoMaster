...
var r = (t3) => {
  ...
  const M2 = t3, W2 = [], I = [], K = [], P3 = [], Z = [], x2 = [], B2 = [], J = [], q = [], z2 = [], G = [], H = "function" == typeof AnimationEffect || void 0 !== d2 && "function" == typeof d2.AnimationEffect, L2 = "function" == typeof Element && "function" == typeof Element.prototype.animate && H, N = () => G, O = (e, o) => {
...
var h2 = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-CBzELu-H-G2BONUYE.js")).iosTransitionAnimation : (await import("./p-CU1SSH8_-XKRVKK7Y.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
  const i2 = n3(e.baseEl, e);
  V(e.enteringEl, e.leavingEl);
  const a = await M(i2, e);
...
var P2 = async (e) => {
  ...
  return await k(e, o), V(i2, a), j(i2, a), { hasCompleted: true };
};
var k = async (n3, e) => {
  (void 0 !== n3.deepWait ? n3.deepWait : e) && await Promise.all([B(n3.enteringEl), B(n3.leavingEl)]), await C(n3.viewIsReady, n3.enteringEl);
};
var C = async (n3, e) => {
  n3 && await n3(e);
};
...
@ionic/core/components/p-9VcRUwdB.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EKA3USLK.js.map
