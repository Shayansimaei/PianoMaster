<template>
  <ion-page>
    <ion-tabs>
      <!-- All tab pages render here -->
      <ion-router-outlet />

      <!-- ONE tab bar, defined once here only -->
      <ion-tab-bar slot="bottom">

        <ion-tab-button tab="play" href="/tabs/play">
          <ion-icon :icon="musicalNoteOutline" />
          <ion-label>Free Play</ion-label>
        </ion-tab-button>

        <ion-tab-button tab="lesson" href="/tabs/lesson">
        ...
        <ion-tab-button tab="Feild" href="/tabs/field">
          <ion-icon :icon="earOutline" />
          <ion-label>Feild</ion-label>
        </ion-tab-button>
...
import {
  ...
  import { musicalNoteOutline,schoolOutline,documentTextOutline,hardwareChipOutline,musicalNotesOutline, earOutline} from 'ionicons/icons';
